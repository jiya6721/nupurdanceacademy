...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="public/assets/modules/jqvmap/dist/jqvmap.min.css">
  <link rel="stylesheet" href="public/assets/modules/summernote/summernote-bs4.css">
  <link rel="stylesheet" href="public/assets/modules/owlcarousel2/dist/public/assets/owl.carousel.min.css">
  <link rel="stylesheet" href="public/assets/modules/owlcarousel2/dist/public/assets/owl.theme.default.min.css">
...
<body>
        ...
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="public/assets/img/products/product-3-50.png" alt="product">
                  oPhone S9 Limited Edition
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="public/assets/img/products/product-2-50.png" alt="product">
                  Drone X2 New Gen-7
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="public/assets/img/products/product-1-50.png" alt="product">
                  Headphone Blitz
                </a>
              </div>
              <div class="search-header">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="public/assets/img/avatar/avatar-1.png" class="rounded-circle">
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="public/assets/img/avatar/avatar-2.png" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Dedik Sugiharto</b>
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="public/assets/img/avatar/avatar-3.png" class="rounded-circle">
                    <div class="is-online"></div>
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="public/assets/img/avatar/avatar-4.png" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="public/assets/img/avatar/avatar-5.png" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Alfa Zulkarnain</b>
  ...
  <!-- JS Libraies -->
  <script src="public/assets/modules/jquery.sparkline.min.js"></script>
  <script src="public/assets/modules/chart.min.js"></script>
  <script src="public/assets/modules/owlcarousel2/dist/owl.carousel.min.js"></script>
  <script src="public/assets/modules/summernote/summernote-bs4.js"></script>
  <script src="public/assets/modules/chocolat/dist/js/jquery.chocolat.min.js"></script>
