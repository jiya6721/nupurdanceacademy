...
<html lang="en">
	...
	<body id="kt_body" class="app-blank">
						...
						<div class="w-lg-600px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" novalidate="novalidate" data-kt-redirect-url="../dist/authentication/sign-in/basic.html" id="kt_sign_up_form">
								...
								<div class="mb-10 text-center">
									...
									<a href="../dist/authentication/sign-in/basic.html" class="link-primary fw-bold">Sign in here</a></div>
									<!--end::Link-->
								</div>
								<!--end::Heading-->
								<!--begin::Action-->
		...
		<script src="public/js/custom/authentication/sign-up/general.js"></script>
